...
>>>>>>> 48f0c120de727872670d25abd70ef1282b2da48a
            ...
            <div className="w-full flex flex-col items-center space-y-6">
              <div className="p-5 bg-slate-50 border border-slate-200 rounded-2xl text-left space-y-2.5 max-w-sm shadow-sm">
                ...
                <ol className="list-decimal list-inside text-xs text-slate-600 space-y-1.5 leading-relaxed font-semibold">
                  <li>Click Start Call To Create A Ticket</li>
                  <li>Press Agree to Terms and Condition</li>
                  <li>Describe your problem to the AI , Answer the questions properly to, make sure to tell your employee ID 1003</li>
                </ol>
              </div>
